...
class AbstractRetriever:
    ...
    def __call__(self, claim: str, k=30):
        # print("Covidex: Retrieving abstracts")
        req = Request(
            url=f"https://covidex.ai/api/search?vertical=cord19&query={quote(claim)}",
            ...
            if data["abstract"]:
                ...
                if "doi.org" in new_url:
                    ...
                    new_url = new_url.replace(
                        "www.ncbi.nlm.nih.gov/pubmed/", "api.semanticscholar.org/pmid:"
                    )
                    ...
                    new_url = new_url.replace(
                        "arxiv.org/pdf/", "api.semanticscholar.org/arxiv:"
                    )
                blob = {
                    "id": data["id"],  # str
